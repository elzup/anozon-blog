						...
						i(t, [
							{
								...
								value: function() {
									var t =
											...
											this.options.wechatImage +
											'" alt="wechat" class="donate-image active">\n            <img src="' +
											this.options.alipayImage +
											'" alt="alipay" class="donate-image">\n          </div>\n        </div>\n      </div>\n    ',
										e =
											'\n      <a href="javascript:;" class="donate-btn"><i class="donate-qrcode"></i>' +
											this.options.btnText +
											'</a>\n    '
									this.el && (this.el.innerHTML = e),
							...
							},
							{
								...
								value: function() {
									...
									;(this.btns = this.modal.querySelectorAll('.donate-tab a')),
										(this.images = this.modal.querySelectorAll(
											'.donate-tab .donate-image'
										)),
										this.modal.addEventListener(
											'click',
											this._modalEvent.bind(t),
											!1
										),
										this.el &&
											this.el.addEventListener(
												'click',
												this._donateBtnEvent.bind(t),
												!1
											)
								},
							},
							{
								...
								value: function(t) {
									if ((t.stopPropagation(), t.target.dataset.index))
										return (
											[].slice.call(this.btns).forEach(function(t) {
							...
							},
							{
								key: '_donateBtnEvent',
								value: function(t) {
									'donate-btn' === t.target.className &&
										(s ? this.hide() : this.show())
								},
							},
							{
								key: 'show',
			...
			function l(t, e, n, o) {
				...
				if (t.styleSheet) t.styleSheet.cssText = y(e, a)
					...
					r[e] && t.removeChild(r[e]),
						r.length ? t.insertBefore(i, r[e]) : t.appendChild(i)
				}
			}
