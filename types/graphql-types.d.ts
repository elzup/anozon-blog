...
export type SitePageFieldsEnum = 
  ...
  | 'pluginCreator___pluginOptions___usePrefix'
  ...
  | 'pluginCreator___pluginOptions___aliases___scss'
...
export type SitePluginFieldsEnum = 
  ...
  | 'pluginOptions___aliases___scss'
...
export type BioDataQueryVariables = Exact<{ [key: string]: never; }>;


export type BioDataQuery = { avatar?: Maybe<{ childImageSharp?: Maybe<{ fixed?: Maybe<Pick<ImageSharpFixed, 'base64' | 'width' | 'height' | 'src' | 'srcSet'>> }> }>, site?: Maybe<{ siteMetadata?: Maybe<(
      Pick<SiteSiteMetadata, 'author' | 'profile'>
...
export type DefaultSeoQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title' | 'description' | 'author' | 'image'>> }> };

export type SideBarQueryVariables = Exact<{ [key: string]: never; }>;


export type SideBarQuery = { allMarkdownRemark: { topics: Array<Pick<MarkdownRemarkGroupConnection, 'fieldValue' | 'totalCount'>> } };

export type Site404QueryVariables = Exact<{ [key: string]: never; }>;
...
export type BlogListBySlugQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, posts: { edges: Array<{ node: (
        Pick<MarkdownRemark, 'excerpt'>
        & { fields?: Maybe<Pick<MarkdownRemarkFields, 'slug'>>, frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'date' | 'topics'>> }
      ) }> } };
...
export type BlogPostBySlugQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title' | 'author' | 'siteUrl'>> }>, markdownRemark?: Maybe<(
    Pick<MarkdownRemark, 'id' | 'excerpt' | 'htmlAst'>
    & { frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'date' | 'topics'>> }
  )> };
...
export type TagSearchQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title' | 'author'>> }>, pages: (
    ...
    & { edges: Array<{ node: (
        Pick<MarkdownRemark, 'excerpt'>
        & { fields?: Maybe<Pick<MarkdownRemarkFields, 'slug'>>, frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'date' | 'title' | 'topics'>> }
      ) }> }
  ) };
