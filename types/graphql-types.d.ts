...
export type BlogListBySlugQuery = {
  site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }>
  posts: {
    edges: Array<{
      node: Pick<MarkdownRemark, 'excerpt'> & {
        ...
        frontmatter?: Maybe<
          Pick<MarkdownRemarkFrontmatter, 'title' | 'date' | 'topics'>
        >
      }
    }>
  }
...
export type BlogPostBySlugQuery = {
  site?: Maybe<{
    siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title' | 'author' | 'siteUrl'>>
  }>
...
export type TagSearchQuery = {
  ...
  pages: Pick<MarkdownRemarkConnection, 'totalCount'> & {
    edges: Array<{
      node: Pick<MarkdownRemark, 'excerpt'> & {
        fields?: Maybe<Pick<MarkdownRemarkFields, 'slug'>>
        frontmatter?: Maybe<
          Pick<MarkdownRemarkFrontmatter, 'date' | 'title' | 'topics'>
        >
      }
    }>
  }
